...
const ListQuery = z.object({
  ...
  status: z
    .enum([...CONTRACT_STATUSES, "available", "mine"])
    .optional(),
});
...
function serialize<T extends { amount: bigint; deadline: Date | null; createdAt: Date; updatedAt: Date; submissionAt: Date | null; disputeOpenedAt: Date | null; disputeResolvedAt: Date | null }>(
  c: T,
) {
  return {
    ...c,
