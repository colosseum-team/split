    ...
    <section id="roadmap" className="lp-section">
      <div className="lp-section-head">
        ...
        <p className="lp-section-lead">
          We&apos;re shipping the smallest thing that pays a freelancer. Then
          stablecoins, then milestones, then reputation that travels with you.
        </p>
      </div>
      ...
      <div className="lp-roadmap">
        {milestones.map((m) => (
          <div
            key={m.when}
            className={`lp-roadmap-item${m.now ? " now" : ""}`}
          >
      ...
      <div className="lp-final">
        <div className="lp-final-card">
          ...
          >
            The full flow runs on Solana devnet right now — no wallet install,
            no real funds, just the experience.
          </p>
