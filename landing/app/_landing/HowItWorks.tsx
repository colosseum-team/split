  ...
  return (
    <section id="about" className="lp-section">
      <div className="lp-section-head">
        ...
        <h2 className="lp-section-title">Three steps from handshake to payout.</h2>
        <p className="lp-section-lead">
          No platform between you and your money. The smart contract holds the funds and follows the
