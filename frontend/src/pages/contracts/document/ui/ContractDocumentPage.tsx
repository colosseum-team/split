...
export const ContractDocumentPage: FC = () => {
  ...
  if (!contract) {
    return (
      <div className="min-h-screen w-full bg-(--color-surface-muted) flex flex-col items-center justify-center gap-3 px-4 py-10">
        <h2 className="text-h2 text-(--color-text-primary)">Contract not found</h2>
        <p className="text-body text-(--color-text-secondary) text-center max-w-[420px]">
  ...
  return (
    <div className="min-h-screen w-full bg-(--color-surface-muted)">
      <div className="sticky top-0 z-10 bg-(--color-surface-overlay) backdrop-blur border-b border-(--color-border-subtle)">
